...
**Confirmed defect — ambiguous Strategy Call / Shop Visit merge:**
`/book-a-strategy-call` H1 reads "Book a Free Strategy Call — See Your Operation Clearly" and body text describes it as "often conducted as an onsite shop visit" — this blurs the two offers the brief wants kept distinct (Strategy Call = the booking action; Shop Visit = the onsite-visit offer). Needs a copy fix distinguishing: Strategy Call can happen by phone/video OR as an onsite Shop Visit, but the page should name that as two paths, not describe one as a variant of the other in passing.
