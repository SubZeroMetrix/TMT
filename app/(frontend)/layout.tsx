...
export const metadata: Metadata = {
  ...
  description:
    "The Modern Trades Mentor helps Tampa Bay contractors choose the right software, AI, and systems for their business — guided by 26+ years of real HVAC and facilities operations experience.",
  openGraph: {
