...
function styles() {
  return `
    * { margin: 0; padding: 0; box-sizing: border-box; }
    ...
    .headline { margin-top: 24px; color: white; font-weight: 800; font-size: 54px; line-height: 1.16; letter-spacing: -0.01em; max-width: 980px; }
    .lede { margin-top: 28px; color: ${SILVER_LIGHT}; font-size: 23px; line-height: 1.5; max-width: 820px; }
...
const posts = require("./weeks-5-13-data.json");
